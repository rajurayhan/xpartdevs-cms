...
<div class="container-fluid">
    ...
    <!-- Page Heading -->
    <h1 class="h3 mb-2 text-gray-800">{{clean( trans('niva-backend.edit_member') , array('Attr.EnableID' => true))}}</h1>

    <!-- DataTales Example -->
    <div class="card shadow mb-4">
        <div class="card-header py-3">
            <h6 class="m-0 font-weight-bold text-primary">{{clean( trans('niva-backend.edit_member') , array('Attr.EnableID' => true))}}</h6>
        </div>
        <div class="card-body">
                		...
                		<form action="{{route('member.update', $member->id)}}" method="POST" enctype="multipart/form-data">
					        ...
					        <div class="row">
                                ...
                                <div class="col-xs-12 col-sm-12 col-md-12">
                                    ...
                                    <div class="row">
                                        <div class="col-md-4">
                                            <div class="form-group">
                                                ...
                                                <input type="text" name="facebook" class="form-control" value="{{$member->facebook}}">
                                            </div>
                                        </div>
                                        <div class="col-md-4">
                                            <div class="form-group">
                                                <strong>{{clean( trans('niva-backend.twitter') , array('Attr.EnableID' => true))}}</strong>
                                                <input type="text" name="twitter" class="form-control" value="{{$member->twitter}}">
                                            </div>
                                        </div>
                                        <div class="col-md-4">
                                            <div class="form-group">
                                    ...
                                    <div class="form-group">
                                        <img class="img-fluid pb-4" width="100" height="100" src="{{$member->photo ? '/images/media/' . $member->photo->file : '/img/200x200.png'}}">
