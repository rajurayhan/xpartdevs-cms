...
(1, 1, 'XpartDevs | Den of Xpart Developers', 'Whether you need a new logo, website, video, marketing campaign, or ebook created for your business, the key to making the project a success starts with having a well-thought-out creative brief.', 'Fun Facts', 'Over the years we have done many things that we are proud of. This motivates us to continue looking for new challenges in order to improve our services.', '425', 'Happy Customers', '12', 'Cups of Coffee', '1320', 'Innovations', '860', 'Great Projects', 'ABOUT AGENCY', 'Unlimited Skills for Super Projects.', '<p>Whether you need a new logo, website, video, marketing campaign, or ebook created for your business, the key to making the project a success starts with having a well-thought-out creative brief. No coding skills required to create unique sites. Customize your site in real-time and see the results <strong>instantly</strong>.</p>', 'Get the offer', 'https://laravel1.lucian.host/pricing', 'https://laravel1.lucian.host/public/images/media/1615636710about-s1.jpg', 'https://laravel1.lucian.host/public/images/media/1615636710about-s2.jpg', '12', 'YEARS OF EXPERIENCE', 'How we can help take your next project to new heights', 'Our premium projects.', 'SELECTED WORKS', 'Our Last News', 'BLOG POSTS', NULL, '2023-01-05 07:48:14'),
...
CREATE TABLE `menus` (
  ...
  `submenu` text COLLATE utf8mb4_unicode_ci,
...
(1, 1, 'Home', '/', 0, NULL, 1, '2021-03-13 15:37:55', '2023-01-05 07:37:36'),
(2, 1, 'About us', '/about-us', 0, NULL, 2, '2021-03-13 15:38:33', '2023-01-05 07:38:00'),
(3, 1, 'Portfolio', '/portfolio', 1, '<div class=\"dropdown-menu\">\r\n    <a class=\"dropdown-item\" href=\"/portfolio\">Our Projects</a>\r\n    <a class=\"dropdown-item\" href=\"/project/niva\">Niva WordPress Theme</a>\r\n    <a class=\"dropdown-item\" href=\"/project/venor\">Venor WordPress Theme</a>\r\n</div>', 3, '2021-03-13 15:39:05', '2023-01-05 07:39:24'),
(4, 1, 'Pricing', '/pricing', 0, NULL, 4, '2021-03-13 15:44:34', '2023-01-05 07:38:30'),
(9, 1, 'Blog', '/blog', 1, '<div class=\"dropdown-menu\">\r\n    <a class=\"dropdown-item\" href=\"/blog\">Our Recent News</a>\r\n    <a class=\"dropdown-item\" href=\"/post/top-6-articles-you-must-read-today-niva\">Top 6 Articles You Must Read</a>\r\n    <a class=\"dropdown-item\" href=\"/post/7-creative-ways-to-boost-your-social-media\">Top 7 Creative Ways to Boost Your Media</a>\r\n</div>', 5, '2021-04-10 20:03:48', '2023-01-05 07:40:00'),
...
(10, 1, 'Contact', '/contact', 0, NULL, 6, '2021-04-10 20:32:52', '2023-01-05 07:38:46'),
...
(121, '1672903447Raju.jpeg', '2023-01-05 07:24:07', '2023-01-05 07:24:07'),
(122, '1672903474simec.png', '2023-01-05 07:24:34', '2023-01-05 07:24:34'),
(123, '1672903630simec.png', '2023-01-05 07:27:10', '2023-01-05 07:27:10');
...
CREATE TABLE `pricings` (
  ...
  `popular_text` text COLLATE utf8mb4_unicode_ci,
  `created_at` timestamp NULL DEFAULT NULL,
  `updated_at` timestamp NULL DEFAULT NULL
) ENGINE=MyISAM DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;
...
CREATE TABLE `projects` (
  ...
  `slug` varchar(191) COLLATE utf8mb4_unicode_ci NOT NULL,
  `body` text COLLATE utf8mb4_unicode_ci NOT NULL,
  `image_featured2` text COLLATE utf8mb4_unicode_ci,
  `img_gal1` text COLLATE utf8mb4_unicode_ci,
  `img_gal2` text COLLATE utf8mb4_unicode_ci,
  `img_gal3` text COLLATE utf8mb4_unicode_ci,
  `img_gal4` text COLLATE utf8mb4_unicode_ci,
...
('ql30QeVlPvm4h3H894VJMEzDD9n8BQMOKnaZ71V2', 1, '172.20.0.1', 'Mozilla/5.0 (X11; Linux x86_64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/108.0.0.0 Safari/537.36', '', 1672905363);
...
CREATE TABLE `settings` (
  ...
  `SchmeaORG` text COLLATE utf8mb4_unicode_ci,
  `SchmeaORG_switch` tinyint(1) NOT NULL DEFAULT '1',
  `OGgraph` text COLLATE utf8mb4_unicode_ci,
...
(1, 'Raju Rayhan', 1, 'raju@xpartdevs.xyz', NULL, '$2y$10$FA6n1mBlu.YGqwUI8acJv.YM4dnSRHTZWdEsM30NQKw0ea6krerGy', NULL, NULL, 'uJmUGVvUWQ4rCErNEOpEIOp1UfWCNp4oObae8orgWS3ziXKjUJiIgPmHk90Q', NULL, NULL, NULL, NULL, NULL, '2021-03-13 15:29:44', '2023-01-05 07:40:48', '121', '3371932529579633');
